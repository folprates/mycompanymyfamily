...
//	 * 
//	 * @param path
//	 *            -- if null/empty, refers to the base-url
//	 * @return {@link FirebaseResponse}
//	 * @throws UnsupportedEncodingException
//	 * @throws {@link
//	 *             FirebaseException}
...
//	 * 
//	 * @param path
//	 *            -- if null/empty, refers to base-url
//	 * @param data
//	 *            -- can be null/empty
//	 * @return {@link FirebaseResponse}
//	 * @throws UnsupportedEncodingException
...
//	 * 
//	 * @param data
//	 *            -- can be null/empty but will result in no data being POSTed
//	 * @return {@link FirebaseResponse}
//	 * @throws UnsupportedEncodingException
//	 * @throws {@link
//	 *             JacksonUtilityException}
...
//	 * way, but instead defines it as 'PUSH'; the API will insert this data
//	 * under the base-url but associated with a Firebase- generated key; thus,
//	 * every use of this method will result in a new insert even if the provided
//	 * data already exists.
//	 * 
//	 * @param jsonData
//	 *            -- can be null/empty but will result in no data being POSTed
...
//	///////////////////////////////////////////////////////////////////////////////
//
//	private StringEntity buildEntityFromDataMap(Map<String, Object> dataMap)
//			throws FirebaseException, JacksonUtilityException {
//
...
//				writer = new StringWriter(); // don't want to later give jackson
//												// partial JSON it might choke
//												// on
//				LOGGER.error(msg);
//				throw new FirebaseException(msg, t);
//
